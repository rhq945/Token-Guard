...
if __name__ == '__main__':
    ...
    if args.model_id == "llama3.1":
        model_path = "/data/rhq/TOKEN-GUARD/halu/models/Meta-Llama-3.1-8B-Instruct"
    elif args.model_id == "qwen3":
        model_path = "/data/rhq/TOKEN-GUARD/halu/models/qwen3-8b"
    elif args.model_od == "llama3.1-3b":
